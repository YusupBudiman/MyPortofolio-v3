...
export default function ContentExperience() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
                      ...
                      {slide.map((exp, j) => (
                        ...
                        text-gray-500 font-semibold 
                          ...
                          `}
                            ...
                            <div
                              className={`
                              absolute overflow-hidden flex items-baseline justify-center bg-gradient-to-b from-[hsl(56,48%,72%)] to-[hsl(44,56%,84%)] rounded-full border-[hsl(44,56%,84%)]
                              
                              w-28 h-28 border-y-2 border-x-1 right-[-4%]
                          ...
                          `}
                              ...
                              <div
                                ...
                                w-21 h-21 mt-1 border-y-1 border-x-2 
      ...
      <MobileButtonBackgroun></MobileButtonBackgroun>
    </div>
  );
}
