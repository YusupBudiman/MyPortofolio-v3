...
export default function ProjectContent({ projects }) {
  ...
  return (
    <div
      className={`
    relative flex flex-col justify-center items-center  w-full h-full
    `}
    >
      <Toast message={toast} />
      ...
      `}
        ...
        `}
          ...
          <div
            className={`hidden
            absolute z-20 lg:flex transform 
        
            top-[50%] gap-2 right-[1%]

            lg:top-[13%] lg:right-[-11%] lg:gap-1 lg:flex-col lg:-translate-x-1/2
        ...
        `}
          >
            ...
            <div
              ...
              w-[10px] h-[10px] border-b-2 border-r-1 border-t-1 border-l-3
